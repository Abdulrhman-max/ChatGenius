...
def build_training_pairs():
    ...
    pricing = [
        ...
        ("What's your pricing?", "Our pricing is simple and transparent: Free plan available at $0, Basic is $23/month, Growth is $79/month (most popular), Pro is $299/month, and Enterprise is $699/month. Every plan includes a 14-day free trial."),
        ("Is there a free plan?", "Yes! We have a completely free plan with 50 conversations per month, 1 doctor, 20 patients max, and basic FAQ responses. No credit card required, free forever. We also offer a 14-day free trial with full access to Growth features so you can experience the full platform risk-free!"),
        ("What's the cheapest plan?", "Our Free plan is $0/month with 50 conversations, 1 doctor, and 20 patients. Our cheapest paid plan is Basic at just $23/month — or $18/month with annual billing. It includes unlimited conversations, 1 chatbot, smart booking, email reminders, and lead capture. Perfect for solo practitioners getting started!"),
        ("Do you have annual pricing?", "Yes! You save 20% with annual billing. Basic drops to $18/month, Growth to $63/month, Pro to $239/month, and Enterprise to $559/month. Plus non-profits get an additional 30% off any plan."),
    ...
    features = [
        ...
        ("Can it book appointments?", "Yes! Appointment booking is available on all plans. Free plan has basic date + time booking. Basic and above get smart booking (service → date → time) with conflict detection. Growth adds doctor breaks, off-days, waitlist, check-in, and syncs with Google Calendar and Calendly. Businesses using it see an average 35% increase in appointments."),
        ...
        ("Can I customize the chatbot?", "Yes! Basic plan gets 3 color presets and the Default widget style. Growth plan unlocks all 3 widget styles (Default, Pill, Glassmorphic), custom avatar, font size, message bubble colors, and calendar styling. Pro plan adds white-label with custom domain and removes all ChatGenius branding. Enterprise gets full chatbot customization."),
        ("What languages does it support?", "Multi-language support varies by plan: Basic supports 3 languages, Growth/Pro/Enterprise support 10 languages. Supported languages include English, Arabic, Spanish, French, Chinese, Urdu, and Tagalog. The chatbot auto-detects the visitor's language and responds accordingly."),
        ...
        ("What analytics do you provide?", "Analytics vary by plan: Free gets chat count only. Basic gets conversation count and booking count. Growth gets the full analytics dashboard with conversion rates, peak hours, doctor revenue, monthly reports, and lead analytics. Pro adds ROI dashboard, real-time SSE notifications, benchmarking, and advanced handoff/survey/upsell analytics."),
    ...
    # ── SUPPORT ──
    support = [
        ("What kind of support do you offer?", "Free and Basic plans include email support. Growth plan gets priority support. Enterprise plan includes a dedicated account manager, SLA guarantee, and quarterly business reviews. All users also have access to our knowledge base, video tutorials, and weekly webinars."),
        ("Do you offer onboarding help?", "Yes! All Growth, Pro, and Enterprise customers get a free 30-minute onboarding call to help configure the chatbot perfectly. Enterprise customers also get priority onboarding and quarterly business reviews. Plus, we have extensive video tutorials, documentation, and a community forum."),
    ...
    trial = [
        ("How does the free trial work?", "Sign up with just your email — no credit card required. You get full access to all Growth features for 14 days. Set up your chatbot, test it on your site, and see the results. After 14 days, choose a paid plan to continue, or stay on our free plan with 50 conversations/month, 1 doctor, and 20 patients max."),
    ...
    misc = [
        ...
        ("Can I use it on multiple websites?", "Yes! Pro plan supports up to 3 chatbots (great for multiple websites or landing pages), and Enterprise plan gives you unlimited chatbots. Free, Basic, and Growth plans include 1 chatbot each. Each chatbot can be customized independently with its own knowledge base, appearance, and settings."),
    ]
    pairs.extend(misc)
