...
def build_training_pairs():
    ...
    # ── GREETINGS ──
    greetings = [
        ("Hi", "Hi there! Welcome to ChatGenius. I'm here to help you learn about our AI chatbot platform. What would you like to know — features, pricing, or how to get started?"),
        ("Hello!", "Hello! Great to have you here. I'm the ChatGenius assistant — I can answer any questions about our AI chatbot for businesses. What can I help you with?"),
        ("Hey, what is this?", "Hey! ChatGenius is an AI-powered chatbot platform built for small and medium businesses. We help you automatically answer customer questions, book appointments, and capture leads — 24/7, without any human involvement. Want to learn more?"),
        ...
        ("Hi, I'm interested in your product", "Hi! Great to hear that. ChatGenius is an AI chatbot that you embed on your website to automatically engage visitors, answer their questions, book appointments, and capture leads — all without you lifting a finger. What aspect would you like to know more about?"),
    ]
    pairs.extend(greetings)

    # ── PRICING ──
    pricing = [
        ("How much does it cost?", "We have three plans: Basic at $49/month (500 conversations, 1 chatbot), Pro at $149/month (5,000 conversations, 3 chatbots, appointment booking, CRM integration), and Agency at $299/month (unlimited everything, white-label, API access). All plans come with a free 14-day trial — no credit card needed!"),
        ("What's your pricing?", "Our pricing is simple and transparent: Basic is $49/month for small businesses, Pro is $149/month for growing businesses that need booking and CRM features, and Agency is $299/month for agencies and larger teams. Every plan includes a 14-day free trial with full Pro access."),
        ...
        ("What's the cheapest plan?", "Our Basic plan starts at just $49/month — or $39/month if you go with annual billing. It includes 500 conversations, 1 chatbot, lead capture, and email support. Perfect for solo businesses getting started. And you can try it free for 14 days first!"),
        ("Do you have annual pricing?", "Yes! You save 20% with annual billing. Basic drops to $39/month, Pro to $119/month, and Agency to $249/month. Plus non-profits get an additional 30% off any plan."),
        ("What's included in the Pro plan?", "The Pro plan at $149/month includes 5,000 conversations, 3 chatbots, advanced lead capture, automated appointment booking, CRM integration with HubSpot/Salesforce/Zoho, calendar sync, priority support, advanced analytics, custom chatbot personality, multi-language support, and conversation exports. It's our most popular plan!"),
        ("What's the Agency plan?", "The Agency plan at $299/month is built for agencies and larger businesses. It includes everything in Pro, plus unlimited conversations and chatbots, white-label branding, full API access, a dedicated account manager, custom integrations, team management for up to 10 users, SOC 2 compliance, custom AI training, webhook support, and an SLA guarantee. You also get a priority onboarding call and quarterly business reviews."),
        ...
        ("What happens if I go over my conversation limit?", "We'll notify you when you hit 80% of your limit so there are no surprises. If you go over, conversations continue without interruption — additional conversations are billed at just $0.05 each. You can also upgrade your plan anytime to get more capacity."),
    ...
    features = [
        ...
        ("Can it book appointments?", "Yes! Our appointment booking feature is available on Pro and Agency plans. Customers browse available time slots right in the chat, pick a time, and get an automatic confirmation email. It syncs in real-time with Google Calendar, Outlook, or Calendly to prevent double-bookings. Businesses using it see an average 35% increase in appointments."),
        ...
        ("Can I customize the chatbot?", "Absolutely! You can customize the colors, avatar, position, welcome message, and conversation style to match your brand perfectly. On Pro and above, you can also set the chatbot's personality and tone. Agency plans let you fully white-label with your own branding."),
        ("What languages does it support?", "On Pro and Agency plans, ChatGenius supports 10 languages: English, Spanish, French, German, Portuguese, Italian, Dutch, Japanese, Korean, and Chinese. The chatbot auto-detects the visitor's language and responds accordingly."),
        ("Can it hand off to a human?", "Yes! When the AI encounters a question it can't confidently answer, or when a visitor explicitly requests a human, the conversation is seamlessly transferred to your team via email, Slack, or the ChatGenius dashboard. You set the rules for when handoff occurs."),
    ...
    # ── SETUP ──
    setup = [
        ("How do I set it up?", "Setting up ChatGenius is easy — it takes under 5 minutes: 1) Sign up for free, 2) Complete the quick setup wizard with your business info, 3) Upload your knowledge base or let our AI learn from your website, 4) Customize the look and feel, 5) Copy one line of code to your site, and you're live! No coding or technical skills needed."),
        ...
        ("How long does setup take?", "Basic setup takes under 5 minutes — just sign up, enter your business info, and paste the code. For full customization with a complete knowledge base, plan for about 15-30 minutes. Pro and Agency customers also get a free onboarding call to help optimize their setup."),
    ]
    pairs.extend(setup)

    # ── INDUSTRIES ──
    industries = [
        ("Does it work for dental offices?", "Absolutely! ChatGenius is very popular with dental practices. It handles appointment scheduling, answers insurance questions, provides service information, manages new patient intake, and sends post-visit follow-ups — all automatically. Many dental offices see a 35-40% increase in bookings."),
        ("Can it work for a law firm?", "Yes! Law firms use ChatGenius to qualify potential cases, book consultations, provide practice area information, collect intake forms, and answer basic questions about office hours and location. It pre-qualifies leads so your attorneys only speak with serious prospects."),
        ...
        ("Does it work for real estate?", "Yes, real estate is one of our top industries! Agents use ChatGenius to field property inquiries, schedule showings, qualify buyers and sellers, provide neighborhood information, and connect prospects with mortgage resources. It ensures you never miss a hot lead, even at 2 AM."),
    ...
    comparisons = [
        ...
        ("What makes ChatGenius different from regular chatbots?", "Regular chatbots follow rigid scripts and break when customers go off-script. ChatGenius uses real AI that understands natural language, maintains context throughout the conversation, handles unexpected questions gracefully, and improves over time. It's the difference between a phone tree and talking to a knowledgeable human."),
    ]
    pairs.extend(comparisons)

    # ── SECURITY ──
    security = [
        ("Is my data safe?", "Absolutely. All data is encrypted with AES-256 at rest and TLS 1.3 in transit. We're GDPR and CCPA compliant, hosted on AWS with 99.9% uptime, and Agency plan includes SOC 2 Type II compliance. We never sell customer data — you own all your conversation data and can export or delete it anytime."),
        ...
        ("Where is my data stored?", "All data is stored on AWS infrastructure with AES-256 encryption at rest. Data is retained for 12 months by default, with custom retention periods available on the Agency plan. You can export or delete your data at any time from the dashboard."),
    ]
    pairs.extend(security)

    # ── SUPPORT ──
    support = [
        ("What kind of support do you offer?", "Basic plan includes email support with 24-48 hour response. Pro plan gets priority email and chat support with under 4-hour response. Agency plan includes a dedicated account manager, Slack channel, and phone support during business hours. All users also have access to our knowledge base, video tutorials, and weekly webinars."),
        ("Do you offer onboarding help?", "Yes! All Pro and Agency customers get a free 30-minute onboarding call to help configure the chatbot perfectly. Agency customers also get priority onboarding and quarterly business reviews. Plus, we have extensive video tutorials, documentation, and a community forum."),
        ("How do I contact support?", "You can reach our support team through the ChatGenius dashboard, email, or our help center at help.chatgenius.ai. Pro customers get priority chat support, and Agency customers have a dedicated account manager and Slack channel. We also run weekly live webinars where you can ask questions."),
    ]
    ...
    trial = [
        ...
        ("I want to get started", "Awesome! Getting started is easy and free. Just head to chatgenius.ai, sign up with your email (no credit card needed), and follow the 5-minute setup wizard. You'll have a working AI chatbot on your website today. Want me to walk you through any specific part of the process?"),
    ...
    misc = [
        ...
        ("Can I use it on multiple websites?", "Yes! Pro plan supports up to 3 chatbots (great for multiple websites or landing pages), and Agency plan gives you unlimited chatbots. Each chatbot can be customized independently with its own knowledge base, appearance, and settings."),
    ]
    pairs.extend(misc)
