...
def build_training_pairs():
    ...
    pricing = [
        ...
        ("Is there a free plan?", "We offer a 14-day free trial with full access to all Pro features — no credit card required. After the trial, if you don't choose a paid plan, you'll move to a limited free tier with 200 conversations per month. It's a great way to test things out risk-free!"),
